    ...
    return (
        <header className="bg-header">
            <div className="content">
                <p className="text-header-presentation">Hello, La fille sur l'arc-en-ciel c'est moi Emilie !<br/> Je suis graphiste et travaille essentiellement sur des illustrations.</p>
